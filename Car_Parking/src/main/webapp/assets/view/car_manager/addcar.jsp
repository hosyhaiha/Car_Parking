...
<body>
	...
	<div class="container-fluid ">
		<div class="row">
			...
			<div class="col-md-10 px-5 pt-4">
				...
				<form action="<%=request.getContextPath()%>/addcar" name="addForm" method="post" onsubmit="return validateCar()">
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" id="licenseplate"
								name="licenseplate" placeholder="Enter licenseplate" required="required">
						</div>
						<p class="col-md-3" id="licenseplateserr" style="color: red;"></p>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" id="cartype"
								name="cartype" placeholder="Enter car type" required="required">
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" id="carcolor"
								name="carcolor" placeholder="Enter car color" required="required">
						</div>
	...
	<script type="text/javascript"
		...
		function validateCar() {
			var licenseplate = document.addForm.licenseplate.value;
			var cartype = document.addForm.cartype.value;
			var carcolor = document.addForm.carcolor.value;
			if(licenseplate.match(/^ *$/) !== null){
				document.getElementById("licenseplateserr").innerHTML = "License plates is invalid";
				alert("License plates is invalid");
				document.addForm.licenseplate.value ='';
				return false;
