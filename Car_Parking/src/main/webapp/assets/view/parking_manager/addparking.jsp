	...
	<div class="container-fluid ">
		<div class="row">
			...
			<div class="col-md-10 px-5 pt-4">
				...
				<form action="<%=request.getContextPath()%>/addparking" method="post" name="addForm" onsubmit="return validatePark()">
					<div class="form-group row">
						<span class="col-md-2 col-form-label text-md-left"> <strong>Parking
								name</strong> <label>(*)</label></span>
						<div class="col-md-6">
							<input type="text" class="form-control" id="parkinglotname"
								name="parkinglotname" placeholder="Enter parking lot name" required="required">
						</div>
						<p class="col-md-3" id="parkinglotnameerr" style="color: red;"></p>
					</div>

					<div class="form-group row">
						<span class="col-md-2 col-form-label text-md-left"> <strong>Place</strong>
							<label>(*)</label></span>
						<div class="col-md-6">
					...
					<div class="form-group row">
						<span class="col-md-2 col-form-label text-md-left"><strong>Area</strong>
							<label>(*)</label></span>
						<div class="col-md-6">
					...
					<div class="form-group row">
						<span class="col-md-2 col-form-label text-md-left"><strong>Price</strong>
							<label>(*)</label></span>
						<div class="col-md-6">
					...
					<div class="form-group row ">
						<span class="col-md-2 col-form-label text-md-left"></span>
						<div class="col-md-6">
	...
	<script type="text/javascript"
		...
		function validatePark() {
			...
			if(parkinglotname.match(/^ *$/) !== null){
				...
				document.getElementById("areaerr").innerHTML = "Area type is invalid";
				alert("Area type is invalid");
				document.addForm.area.value ='';
				return false;
			}else if(price.match(/^ *$/) !== null){
				document.getElementById("priceerr").innerHTML = "Price color is invalid";
				alert("Price color is invalid");
